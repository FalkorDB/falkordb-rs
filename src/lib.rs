...
//!
//! - [`with_connect_timeout`](FalkorClientBuilder::with_connect_timeout) bounds **setup**:
...
//! - [`with_response_timeout`](FalkorClientBuilder::with_response_timeout) bounds **a
...
pub use client::{
    ...
    builder::{FalkorClientBuilder, DEFAULT_CONNECT_TIMEOUT},
    ConnectionStrategy, ReadPreference,
};
